    ...
    <div class="row">
        <div class="col-md-2 leftNav">
            ...
            <ol class="list-unstyled">
                ...
                <li class="navActive"><a href="/yuncai/backstage/intermediary">我的交易员</a></li>
            </ol>
        </div>
        <div class="col-md-10 rightContent">
            <h4 class="">我的交易员</h4>
            <div class="fontColor">
                <div class="text-center intermediaryImg">
                    <img src="/public/img/intermediary.png" alt="">
                </div>
                <div class="text-center intermediaryName">姓名：<span class="iName"></span></div>
                <div class="text-center intermediaryName">电话：<span class="iTel"></span></div>
                <div class="text-center intermediaryNum">交易员是XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</div>
                <div class="text-center intermediaryName">如有疑问请联系客服进行修改，客服电话xxxxxxxxxxxxx</div>
            </div>
        </div>
...
<script>
    $(function () {
        $.ajax({
            type: "get",
            url: "/yun/member/mytrader",
//            data: "name=John&location=Boston",
            success: function(msg){
                if(msg.code==0){
                    var data = msg.trader;
                     $('.iName').text(data.username);
                     $('.iTel').text(data.mobile);
                } else {
                    $('.fontColor').html('<div class="text-center">暂无交易员</div>');
                }
