        ...
        <div class="col-md-10 rightContent">
            <div class="tabbable" id="tabs">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#panel-1" data-toggle="tab">出售中的商品</a></li>
                    <li class=""><a href="#panel-2" data-toggle="tab" >仓库中的商品</a></li>
                </ul>
                <a href="supplierGoodsedit" class="btn btn-default" id="submitGoods">发布商品</a>
...
<script src="/public/yun_js/member/supplierGoods.js"></script>
<#include "../foot.ftl">
</html>