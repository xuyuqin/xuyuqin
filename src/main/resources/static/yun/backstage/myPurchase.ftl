    ...
    <div class="row">
        <div class="col-md-2 leftNav">
            ...
            <ol class="list-unstyled">
                ...
                <li class="navActive"><a href="/yuncai/backstage/purchase">我的找货</a></li>
        ...
        <div class="col-md-10 rightContent">
            ...
            <div class=" orderSearch">
                <button class="redBtn">免费找货</button>
            </div>
            <div class="clearfix fontColor">
                <div class="pull-right clearfix">
                    <div class="searchP clearfix">
                        ...
                        <input type="text" class="searchInput" placeholder="请填写找货名称">
...
<script >
        ...
        function deleteResources(obj) {
            ...
            $.ajax({
                url: '/yun/tyundemand/deleteRelease',
                type: 'post',
                data: {
                    id: id
                },
                        ...
                        if(msg.page.list.length>0){
                            for (var i = 0; i < list.length; i++) {
                                var html = '<ul class="nearOrderUl clearfix  productLists" id="' + list[i].id + '">'
                                        ...
                                        + '<li class="width120">'+list[i].replyCount+'</li>'
                                        + '<li class="width180">'
                                        + '<a href="">查看</a>'
                                        + '<a href="">修改</a>'
...
<#--<script src="/public/yun_js/member/mypurchase.js"></script>-->
<#--<script type="text/html" id="tMainTpl">-->
    ...
    <#--<tr>-->
        ...
        <#--</td>-->
        <#--<td>-->
            <#--<%=content[i].createTime  %>-->
        <#--</td>-->
        <#--<td>-->
            <#--<%=content[i].amount  %>-->
        <#--</td>-->
        <#--<td>-->
            <#--<a href="${app.approot}www/demand/price?demandId=<%=content[i].id  %>" class="btn btn-default">-->
                <#--查看-->
            <#--</a>-->
            <#--<a href="${app.approot}www/demand/edit?demandId=<%=content[i].id  %>"class="btn btn-default">-->
                <#--修改-->
            <#--</a>-->
            <#--<a class="btn btn-default del" demandId="<%=content[i].id  %>">-->
                <#--删除-->
            <#--</a>-->
        <#--</td>-->
    <#--</tr>-->
